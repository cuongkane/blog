...
image: "/images/ideal_software_architecture/intro.webp"
date: "2023-11-13"
author: "cuongkane"
published: true
...
It's equally important to consider 4 non-functional requirements:
...
#### Advantages
- Good for maintainability: Decouple from libraries and frameworks (But still couple on Programming Language). Additionally, separation of concerns when system components are categorized into specified layers with concrete roles. Easy to replace port or adapter in case of incident.
